package com.example.finalproject_cthru.view.camera
...
import com.example.finalproject_cthru.databinding.ActivityCameraBinding
import com.example.finalproject_cthru.utils.createCustomTempFile
        ...
        imageCapture.takePicture(
            ...
            object : ImageCapture.OnImageSavedCallback {
                override fun onImageSaved(output: ImageCapture.OutputFileResults) {
                    ...
                    val intent = Intent()
                    intent.putExtra(EXTRA_CAMERAX_IMAGE, output.savedUri)
